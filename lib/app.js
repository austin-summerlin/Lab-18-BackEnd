...
app.get('/api/squirrel-sightings', async (req, res) => {
  ...
  try {
    ...
    request.get('https://data.cityofnewyork.us/resource/gfqj-f768.json?story_topic_accidental_poems=true');

    const transformedSquirrelData = transformSightings(response.body);
